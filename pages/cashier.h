void drawCashierMenu() {
  ...
  std::cout << " MENU KASIR: " << std::endl;
  Interface::color(7,0);

  Interface::xy(2,3); std::cout<<"[1] PEMBAYARAN"<<std::endl;
  Interface::xy(2,4); std::cout<<"[0] KEMBALI"<<std::endl;
...
void Route::Cashier(){
  ...
  do{
    ...
    Interface::drawX(2,6, 12, 205);
    Interface::xy(1,6); std::cout << char(201);
    Interface::xy(1,7); std::cout << char(186);
    Interface::xy(1,8); std::cout << char(200);
    Interface::xy(14,6); std::cout << char(187);
    Interface::xy(14,7); std::cout << char(186);
    Interface::drawX(2,8, 12, 205);
    Interface::xy(14,8); std::cout << char(188);
    Interface::xy(3,7); std::cout << char(175) << " ";
    std::cin >> opt;
